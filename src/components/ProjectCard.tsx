...
export default function ProjectCard({ project } : { project: repository }) {
    ...
    return (
        <div className="w-full border px-5 py-2 rounded-xl mb-2 relative">
            <div className="mb-2">
            ...
            <div className="flex gap-2 items-baseline">        
                ...
                <span className="text-sm opacity-70">
                    {(project.defaultBranchRef.target.history.totalCount / Math.round(Math.abs((+(new Date(project.updatedAt)) - +(new Date(project.pushedAt))) / day))).toFixed(2)} Commits / Day
                </span>
            </div>
